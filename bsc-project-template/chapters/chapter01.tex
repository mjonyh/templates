...
This project report is organized as follows: Chapter \ref{ch:theory} details the mathematical and physical background of non-linear optics. Chapter \ref{ch:methodology} describes the experimental Z-scan setup and the code used for simulation. Chapter \ref{ch:results} outlines the results and plots. Chapter \ref{ch:discussion} provides interpretations and comparison, while Chapter \ref{ch:conclusion} concludes the project report and outlines potential future improvements.
